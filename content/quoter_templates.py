...
"""
        ...
        links = f"""
<label class="link" for="signinCheckbox">Ben nu al helemaal klaar met dit kwartiel</label>
"""

    return f"""<!DOCTYPE html>
<html lang="en-US">
<head>
  <title>{title or "DevOps Security"}</title>
  <meta charset="utf-8">
...
<header>
  <div class="title">
    <a class="home" href="/">DevOps Security</a>
    {links}
  </div>
</header>
